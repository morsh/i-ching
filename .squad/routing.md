...
| Memory, decisions merge, session and orchestration logs | Scribe |
| Work queue, backlog sweeps, "keep going" | Ralph |
| Content safety, RAI review, divination-framing/disclaimer concerns | Rai |

## Notes

- Divination content is advisory/entertainment. Any framing that could read as medical, legal, or financial advice routes to Rai for review.
- Randomness implementation changes always get a Tank review pass.
